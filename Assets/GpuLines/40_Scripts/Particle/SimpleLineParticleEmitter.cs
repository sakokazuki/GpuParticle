...
namespace SKZ.GPULines {
	...
	public class SimpleLineParticleEmitter : LineParticleEmitter
	{
		...
		public override void SetTexture(Texture posTex, Texture velTex)
		{
		...
		void UpdateKernel()
		{
			computeShader.SetFloat("_EmitVelocityThreshold", velocityThreshold);
